...
class Finolog:
    ...
    def add_package_item_by_id(self, package_id, item_id, count, price,project_id):
    ...
    def change_package_item_by_id(self, package_id, package_item_id, count, price,project_id):
